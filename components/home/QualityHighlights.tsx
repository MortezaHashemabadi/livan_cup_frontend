...
const features: FeatureItem[] = [
  {
    icon: Droplet,
    title: "تولید با تکنولوژی اولتراسونیک",
    desc: "بدون استفاده از چسب؛ اتصال اولتراسونیک برای عملکرد مطمئن‌تر در برابر نوشیدنی‌های داغ، بدون بوی نامطبوع، چکه و سوراخ‌شدن.",
  },
  {
    icon: Globe2,
    title: "کاغذ ممتاز روسی",
    desc: "کاغذ وارداتی باکیفیت برای استحکام و ظاهر برتر لیوان ها.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "از لیوان بیرون‌بر تا بگ پارچه‌ای، محصولات متنوع برای نیازهای مختلف کسب‌وکار شما.",
  },
  {
    icon: Printer,
    title: "چاپ حرفه‌ای و باکیفیت بالا",
    desc: "چاپ باکیفیت با رنگ‌های زنده و جزئیات دقیق برای نمایش بهتر هویت بصری برند شما.",
  },
  {
    icon: Leaf,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            تعهد ما به مواد اولیه ممتاز و استانداردهای تولید، در هر محصولی که
            می‌سازیم مشهود است.
          </p>
        </motion.div>
