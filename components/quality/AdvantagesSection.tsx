...
const advantages: AdvantageItem[] = [
  {
    ...
    desc: "اتصال لبه‌های لیوان با فناوری اولتراسونیک، بدون استفاده از چسب؛ مناسب برای نوشیدنی‌های گرم، بدون بوی نامطبوع و با مقاومت بهتر در برابر نشتی.",
  },
  {
    icon: Globe2,
    title: "کاغذ وارداتی روسی",
  ...
  },
  {
    icon: Printer,
    title: "چاپ ممتاز",
    desc: "چاپ دیجیتال با وضوح بالا و رنگ‌های پایدار روی سطح لیوان ها و بگ ها.",
  },
  {
    icon: Leaf,
  ...
  },
  {
    ...
    desc: "کاغذ و پارچه ضخیم‌تر برای استحکام بیشتر و حس لمسی پریمیوم.",
  },
  {
    icon: Printer,
    title: "چاپ باکیفیت و دقیق",
    desc: "چاپ با رنگ‌های زنده و جزئیات دقیق، برای نمایش حرفه‌ای و ماندگار هویت برند شما.",
  },
];
