...
const faqs: FAQItemType[] = [
  {
    question: "چرا در تولید لیوان از چسب استفاده نمی‌کنید؟",
    answer:
      "اتصال اولتراسونیک بدون نیاز به چسب انجام می‌شود و برای استفاده با نوشیدنی‌های گرم، بدون بوی نامطبوع و نشتی طراحی شده است.",
  },
  {
    question: "چه نوع کاغذی استفاده می‌شود؟",
    answer:
      "کاغذ وارداتی روسی با گراماژ بالا که استحکام و ظاهری ممتاز به محصول می‌دهد.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "چاپ دیجیتال با وضوح بالا که رنگ‌ها را پایدار و طرح‌ها را دقیق روی سطح محصولات نمایش می‌دهد.",
  },
];
